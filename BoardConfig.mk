...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := deviant
...
TARGET_KERNEL_CONFIG := deviant_defconfig
TARGET_KERNEL_SOURCE := kernel/infinix/deviant
...
TW_FRAMERATE := 60
TW_EXTRA_LANGUAGES := false #(Reduce the Total Size of the Boot Partition to 32MB)
...
# Exclude (Reduce the Total Size of the Boot Partition to 32MB)
